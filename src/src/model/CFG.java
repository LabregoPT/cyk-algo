...
public class CFG {
    ...
    /**
     * Determines whether or not the given string can be generated by this CFG.
     * @param word The word to be analyzed in this CFG.
     * @return true if this CFG can generate the given word, false otherwise.
     */
    public boolean cyk(String word){
        //TO-DO
